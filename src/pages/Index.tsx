...
const questions: Question[] = [
  ...
  options: ["I have read, understood, and agree to Delta Digital Academy's Terms & Conditions. I confirm that all personal information I have provided is correct to the best of my knowledge and belief."],
},
];
